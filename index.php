...
<body>
    <header>
        ...
        <div class="frase">
            ...
            <br>
               Loja For Man For Woman com os melhores preços e variedades - FRETE GRATIS PARA TODO O BRASIL!
            </p>
        </div>
        <nav>
            <a class="logo" href="html-login.php"><h3>f.MW</h3></a>
            ...
            <ul class="nav-list">
                <li><a href="html-login.php">PRODUTOS</a></li>
                <li><a href="html-login.php">PROMOÇÕES</a></li>
                <li><a href="html-login.php">SOBRE</a></li>
        ...
        <div class="space-secoes03">
            ...
            <div class="header02" id="header02">
                <div class="secoes-prod">
                    ...
                    <a href="html-login.php"><img src="tshirt 01-png.png" class="camisa04" alt="">
                        <ul class="listas">
                            <li>Camisa Manga Curta - Unissex</li>
                            <li><br> R$250 <button class="btn-comprar">COMPRAR</button></li>
                        </ul>
                    </a>
                    <a href="html-login.php"><img src="cavada.png" class="camisa05" alt="">
                        <ul class="listas">
                            <li>Camisa Cavada </li>
                            <br>
                    ...
                    <a href="html-login.php"><img src="camisa 03-png.png" class="camisa03" alt="">
                        <ul class="listas">
            ...
            <div class="header02" id="header02">
                <div class="secoes-prod">
                    <a href="html-login.php"><img src="calca 01-png.png" class="calca01" alt="">
                        <ul class="listas">
                            <li>Calça Social</li>
                            <br>
                    ...
                    <a href="html-login.php"><img src="calca 02-png.png" class="calca02" alt="">
                        <ul class="listas">
                            <li>Calça Esportiva - Unissex</li>
            ...
            <div class="header02" id="header02">
                <div class="secoes-prod">
                    ...
                    <a href="html-login.php"><img src="sapato 01-png.png" class="sapato01" alt="">
                        <ul class="listas">
                    ...
                    <a href="html-login.php"><img src="tenis 01-png.png" class="tenis01" alt="">
                        <ul class="listas">
                            <li>Tenis - Unissex</li>
                            <br>
                    ...
                    <a href="html-login.php"><img src="sapatenis 01-png.png" class="sapatenis01" alt="">
                        <ul class="listas">
                            <li>Sapa tênis - Masculino</li>
                            <br>
